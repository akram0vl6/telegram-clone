...
import { formSchema, oldEmailSchema, OtpSchema } from "@/lib/validation";
...
const EmailForm = () => {
  ...
  function onEmailSubmit(data: z.infer<typeof oldEmailSchema>) {
    console.log("Email submitted:", data);
    otpForm.setValue("email", data.email);
    setVerify(true);
  }

  function onVerifySubmit(data: z.infer<typeof OtpSchema>) {
