    ...
    <div className="w-full flex items-center justify-between sticky top-0 z-50 h-[8vh] p-2 border-b bg-background">
      <div className="flex items-center">
        <Avatar className="w-8 h-8 z-10">
          ...
          />
          <AvatarFallback className="w-8 h-8 uppercase flex items-center justify-center text-sm">
          ...
          <SheetHeader>
            <SheetTitle />
					<div className='mx-auto w-1/2 max-md:w-1/4 h-36 relative '>
						<Avatar className='w-full h-36 rounded-full'>
							<AvatarImage src={currentContact?.avatar} alt={currentContact?.email} className='object-cover rounded-full' />
